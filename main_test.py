...
def main():
	...
	# Setting empty arrays to hold different values for the plot

	# x holds the nu values
	x = []
	# y holds the F5 values
	y = []
	# z holds the F9 values
	z = []
	...
	with open("./output/data.csv", "a") as OurData:
		np.savetxt(OurData, matrix, delimiter=",", header="t_days, log_F5, log_F9, nu", comments='', fmt='%.15f')
	...
	ax.plot(x[0], y[0], 'k-', linewidth=2, linestyle="dashed", label=f"F5 iteration 1")
	ax.plot(x[1], y[1], 'r-', linewidth=2, linestyle="dashed", label=f"F5 iteration 2")
	ax.plot(x[2], y[2], 'b-', linewidth=2, linestyle="dashed", label=f"F5 iteration 3")
	ax.plot(x[3], y[3], 'g-', linewidth=2, linestyle="dashed", label=f"F5 iteration 4")
	ax.plot(x[4], y[4], 'm-', linewidth=2, linestyle="dashed", label=f"F5 iteration 5")

	ax.plot(x[0], z[0], 'k-', linewidth=1, linestyle="solid", label=f"F9 iteration 1")
	ax.plot(x[1], z[1], 'r-', linewidth=1, linestyle="solid", label=f"F9 iteration 2")
	ax.plot(x[2], z[2], 'b-', linewidth=1, linestyle="solid", label=f"F9 iteration 3")
	ax.plot(x[3], z[3], 'g-', linewidth=1, linestyle="solid", label=f"F9 iteration 4")
	ax.plot(x[4], z[4], 'm-', linewidth=1, linestyle="solid", label=f"F9 iteration 5")
	...
	ax.set_ylabel("Log(F5) [Jy]")
	ax.set_zlabel("Log(F9) [Jy]")
	plt.savefig("./output/GRBA.png")
	...
	plt.figure()
	plt.plot(np.log10(nu), log_F5, label=f'{t_days}')
